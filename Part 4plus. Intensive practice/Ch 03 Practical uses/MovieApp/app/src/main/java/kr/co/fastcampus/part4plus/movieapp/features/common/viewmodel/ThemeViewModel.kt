package kr.co.fastcampus.part4plus.movieapp.features.common.viewmodel
...
class ThemeViewModel @Inject constructor() : ViewModel() {
	...
	val themeState: StateFlow<ComponentConfig> get() = _themeState
	...
	val nextColorState: StateFlow<Color> get() = _nextColorState
